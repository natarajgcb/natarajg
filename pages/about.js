  ...
  return (
    <MNGPage meta={mngprops.meta} og={mngprops.og}>
      ...
      <MNGBody>
        ...
        <br/><br/>Please allow the following words of love from our Beloved Community guide you to other parts of our <ChakraLink as={Link} href="/sovereignwebpresence">Sovereign Web Presence</ChakraLink> as we add more to these About pages...
      </MNGBody>
