...
export default function Home() {
  ...
  return (
    <MNGPage meta={mngprops.meta} og={mngprops.og}>
      ...
      <MNGBody><a href="mailto:one@natarajg.space?subject=Creating%20With%20Master%20Nataraj%20G">Contact us</a> and let us know the what you are building and would like to share with the world.</MNGBody>
